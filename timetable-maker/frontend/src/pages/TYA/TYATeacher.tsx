    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-50 to-indigo-100">
      ...
      <nav className="bg-indigo-600 text-white p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/users" className="hover:text-indigo-200 transition-colors">
        ...
        <div className="flex justify-between items-center mb-6">
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <Button onClick={handleAddTeacher} className="w-full bg-indigo-500 hover:bg-indigo-600 text-white transition-colors">Add Teacher</Button>
            </DialogContent>
          </Dialog>

          <Link to="/tya/create-timetable">
            <Button className="bg-purple-500 hover:bg-purple-600 text-white transition-colors">
            ...
            {teachers.length > 0 ? (
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {teachers.map((teacher) => (
                  <Card key={teacher._id} className="bg-gradient-to-br from-indigo-50 to-blue-50 hover:shadow-md transition-shadow">
                    <CardContent className="p-6">
                      <div className="flex items-center space-x-4">
                        <Avatar className="h-16 w-16 bg-indigo-300 text-indigo-800">
                          <AvatarFallback>{teacher.name.charAt(0)}</AvatarFallback>
                        </Avatar>
                        <div>
                          <h3 className="text-lg font-semibold text-indigo-800">{teacher.name}</h3>
              ...
              <p className="text-indigo-500 text-center py-4">No teachers added yet.</p>
            )}
          </CardContent>
        </Card>
      </div>
      ...
      <footer className="bg-indigo-800 text-white py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 border-t border-indigo-700 pt-8 text-sm text-indigo-400">
